...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    //UIControl
    UIControl* control = [[UIControl alloc] initWithFrame:CGRectMake(100, 100, 100, 40)];
    ...
    //MyButton
    MyButton* myButton = [[MyButton alloc] initWithFrame:CGRectMake(100, 150, 100, 40)];
    //设置标题
    [myButton setTitle:@"点我吧" selectTitle:@"哎呦"];
    //添加事件
